...
INSERT INTO `product_category_tb` VALUES (1,'상의'),(2,'하의');
...
CREATE TABLE `product_color_tb` (
  ...
  UNIQUE KEY `product_color_name_UNIQUE` (`product_color_name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product_color_tb` VALUES (1,'black'),(2,'red');
...
INSERT INTO `product_tb` VALUES (1,'상품111',10000,1,1),(4,'상품3',400000,2,2),(5,'상품777',70000,1,1);
	...
	if ifnull(_product_color_id, 0) > 0 
		...
		then
            ...
            set product_name = vs_product_name,
                ...
                product_color_id = _product_color_id,
...
-- Dump completed on 2023-07-28 17:54:37
